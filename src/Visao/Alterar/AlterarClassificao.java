 ...
 * @author Aluno
 */
public class AlterarClassificao extends javax.swing.JFrame {

    /**
     * Creates new form CadastrarClassificao
     */
    public AlterarClassificao() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlterarClassificao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlterarClassificao().setVisible(true);
            }
        });
    }
